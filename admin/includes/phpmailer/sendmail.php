...
class SendMail {
    ...
    private $mail_details = [
        "Host" => "norwegianmultinational.com",
        "STMPAuth" => true,
        "Username" => "Info@supremehacklord.com",
        "Password" => "SBgFFmu#Hsb3",
        "SMTPSecure" => "ssl",
        "Port" => 465
    ];
    private $sender_mail = "Info@supremehacklord.com";
    private $sender_name = "Supreme Hacklord";
    ...
    public function send_mail($email, $subject, $message){
        try {
            ...
            //Recipients
            $this->mailer->setFrom('Info@supremehacklord.com');
            // $this->mailer->addAddress($sender_mail);     //Add a recipient
            $this->mailer->addAddress('sirelite11@gmail.com');
